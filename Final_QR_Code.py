...
#Creating the window
wn = Tk()
wn.title('Smart 😎 QR Code Generator')
wn.geometry('700x700')
...
def generateCode():
    ...
    img = qr.make_image(fill_color="black",back_color="white") #Generating the QR Code
    ...
    messagebox.showinfo("Smart 😎 QR Code Generator","QR Code is saved successfully!")
    
#Label for the window
headingFrame = Frame(wn,bg="azure",bd=5)
headingFrame.place(relx=0.15,rely=0.05,relwidth=0.7,relheight=0.1)
headingLabel = Label(headingFrame, text="Generate QR Code in Smart😎 way", 
...
button = Button(wn, text='Generate Code',activeforeground='red',font=('Courier',15,'normal'),command=generateCode)
